...
#+begin_src elisp
  ...
  (add-to-list 'org-roam-capture-templates
               '("r" "reference" plain "%?"
                 :target
                 (file+head
                  ;; 物理文件依然使用纯净的 citekey 保证安全
                  "reference/${citar-citekey}.org"

                  ;; 这里的 TITLE 我们不再用 ${note-title}，而是直接调用上面的自定义函数
                  "#+TITLE: ${note-title}\n#+CREATED: %U\n#+LAST_MODIFIED: %U\n#+FILETAGS:\n\n* Tasks\n* Problems\n* Methods\n\n"
                  )
                 :unnarrowed t))
  ...
  (defun kazure/org-roam-clean-citar-title ()
    "Clean citar generated titles only."
  ...
  (add-hook 'org-roam-capture-new-node-hook
            #'kazure/org-roam-clean-citar-title)
#+end_src
