...
#+begin_src emacs-lisp
  ...
  (defun kz/org-noter-insert-note-and-id ()
      ...
      (org-id-get-create))
  (define-key org-noter-doc-mode-map (kbd "i") 'kz/org-noter-insert-note-and-id)
  (define-key org-noter-doc-mode-map (kbd "M-i") 'org-noter-insert-precise-note-and-id)

  (define-key org-noter-doc-mode-map (kbd "w") 'pdf-view-previous-line-or-previous-page)
  (define-key org-noter-doc-mode-map (kbd "s") 'pdf-view-next-line-or-next-page)
  (define-key org-noter-doc-mode-map (kbd "d") 'image-forward-hscroll)
  (define-key org-noter-doc-mode-map (kbd "a") 'image-backward-hscroll)
...
#+begin_src emacs-lisp 
  ...
  (setq user-mail-address (getenv "ZOHO_USER"))
...
#+begin_src elisp
  ...
  (setq eaf-browser-keybinding
    (remove '("M-o" . "eval_js") eaf-browser-keybinding))
  (setq eaf-browser-keybinding
    (remove '("M-o" . "eval_js") eaf-browser-keybinding))
#+end_src
