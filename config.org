     ...
     (
      ...
      (alltodo ""
               ((org-agenda-overriding-header "ALL TODO ITEMS")
                ...
                ;; (org-agenda-prefix-format "%c%l%i %s")
                (org-agenda-prefix-format
                 "%(let ((c (or (org-get-category) \"\"))) (if (> (length c) 10) (concat (substring c 0 7) \"…\") c))%l%i %s")
...
#+begin_src emacs-lisp
  ...
  ;;      charset
  ;;      (font-spec :family "Dream Han Serif CN-extrabold" :size 12) ; Your chosen Chinese font
