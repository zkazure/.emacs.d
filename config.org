...
#+begin_src emacs-lisp
  ...
  (add-hook 'prog-mode-hook #'(lambda () (display-line-numbers 1)))
...
#+begin_src emacs-lisp
  ...
  (add-to-list 'org-capture-templates
               '("t" "Todo" entry (file+header "~/Documents/org/todo.org" "GTD")
                 "* TODO %^{title}\n%?"))

  (add-to-list 'org-capture-templates
               '("m" "Mail" entry (file+header "~/Documents/org/todo.org" "GTD")
...
#+begin_src emacs-lisp
  ...
  (setq gptel-directives
        '(
          ...
          (rewrite
           . "Please rewrite the following words or paragraphs and preserve original length as much as possible.")
          (super-rewrite
