...
** popper
:PROPERTIES:
:HEADER-ARGS: :tangle lisp/init-popper.el
:END:
...
#+begin_src emacs-lisp
  ...
  ;; (global-set-key (kbd "C-t RET") 'tab-switch)
  ;; (global-set-key (kbd "C-t 0") 'tab-close)
  ;; (global-set-key (kbd "C-t 1") 'tab-close-other)
  ;; (global-set-key (kbd "C-t 2") 'tab-new)

  ;; (global-set-key (kbd "C-t g") 'tab-group)

  ;; (global-set-key (kbd "C-t N") 'tab-new-to)
  ;; (global-set-key (kbd "C-t n") 'tab-duplicate)  
  ;; (global-set-key (kbd "C-t M") 'tab-move-to) ;; ???
  ;; (global-set-key (kbd "C-t m") 'tab-move)

  ;; (global-set-key (kbd "C-t b") 'switch-to-buffer-other-tab)
  ...
  ;; (global-set-key (kbd "C-t C-r") 'find-file-read-only-other-tab)

  ;; (global-set-key (kbd "C-t p") 'project-other-tab-command)
  ;; (global-set-key (kbd "C-t r") 'tab-rename)
  ;; (global-set-key (kbd "C-t t") 'other-tab-prefix)
...
#+begin_src emacs-lisp
  ...
  (setq easy-nav-map
        (let ((map (make-sparse-keymap)))
          ...
          (define-key map (kbd "N") #'scroll-up-one-line)
          (define-key map (kbd "P") #'scroll-down-one-line)
          ...
          (define-key map (kbd "s") #'counsel-rg)
          (define-key map (kbd "i") #'counsel-rg)
          (define-key map (kbd ",") #'my/counsel-rg-current-file)
          (define-key map (kbd ".") #'my/counsel-rg-current-file)
  ...
  (defun my/counsel-rg-current-file (initial-input)
    "Search in current file using counsel-rg."
    (interactive "sSearch in current file: ")
    (let ((counsel-rg-base-command (format "rg --no-heading --line-number --color-never -- %s %s" initial-input (buffer-file-name))))
