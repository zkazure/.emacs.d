...
#+begin_src emacs-lisp
  ...
  (setq zot_bib
        '("~/Documents/org/roam/biblio.bib")
                                          ; Zotero 用 Better BibTeX 导出的 .bib 文件. 可以是多个文件
        zot_pdf "~/Documents/zotero/" ; Zotero 的 ZotFile 同步文件夹
        org_refs "~/Documents/org/roam/reference/" ) ; 自定义的 org-roam 文献笔记目录. 我的 org-roam 根目录是 ~/repos/notes
...
#+begin_src emacs-lisp
  (setq my-org-roam-template-coding
        (concat "#+TITLE: ${title}\n"
                "#+FILETAGS: :draft:%?:\n\n"))

  (setq my-org-roam-template-idea
        (concat "#+TITLE: ${title}\n"
                "#+FILETAGS: :draft:%?:"))

  (setq my-org-roam-template-article
        (concat "#+TITLE: ${title}\n"
                "#+FILETAGS: :draft:article:%?:"))

  (setq my-org-roam-template-reference
        (concat "#+TITLE: ${title}\n"
                "#+FILETAGS: :draft:article:%?:"))

  (setq my-org-roam-template-main
        (concat "#+TITLE: ${title}\n"
                "#+FILETAGS: :draft:article:%?:"))

  (add-to-list 'org-roam-capture-templates
               '("c" "Coding" plain
  	       (file+head "coding/%<%Y%m%d%H%M%S>-${slug}.org"
  			  my-org-roam-template-coding)
  	       :immediate-finish t
  	       :unnarrowed t))

  (add-to-list 'org-roam-capture-templates
               '("i" "Ideas" plain
  	       (file+head "idea/%<%Y%m%d%H%M%S>-${slug}.org"
  			  my-org-roam-template-idea)
  	       :immediate-finish t
  	       :unnarrowed t))
  ...
  (add-to-list 'org-roam-capture-templates
  	       ...
  	       (file+head "reference/%<%Y%m%d%H%M%S>-${slug}.org"
  			  my-org-roam-template-reference)
  	       :immediate-finish t
  	       :unnarrowed t))
...
#+begin_src emacs-lisp  :tangle no
  ...
  (add-to-list 'org-roam-capture-templates
               ...
               `("p" "project test" plain
                 ,my-org-roam-project-template
                 :target
                 (file+head "test/${title}.org" "#+title: ${title}\n")))
#+end_src
