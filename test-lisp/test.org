...
:END:
- [ ] org bullet package
- [ ] fix the emphasize of unable to use the bold in the title. Is it
  necessary?
#+begin_src emacs-lisp
  ...
  (set-face-attribute 'variable-pitch nil
                      :family "Maple Mono NF" ; A good proportional font
...
- [ ] test
*** How to install it
1. get pdf-tools, ~/path/to/pdf-tools/server/autobuild~
2. get tablist
3. tweak tablist.el 
   #+begin_src emacs-lisp
...
** save history
** make the ~M-q~ jump over the emaphize
** org mode
