...
#+begin_src emacs-lisp
  (require 'jinx)
  (add-hook 'emacs-startup-hook #'global-check-mode)
  (add-to-list 'check-exclude-regexps '(t "\\cc")) ; 拼写检查忽略中文
  (keymap-global-set "M-$" #'check-correct)
  (keymap-global-set "C-M-$" #'check-languages)

  (setq check-languages "en_GB en_US")
#+end_src
*** other checker
#+begin_src elisp
  ;; (use-package flymake
