...
#+begin_src emacs-lisp
  ...
  (add-hook 'toml-ts-mode-hook #'(lambda () (display-line-numbers-mode 1)))
...
#+begin_src emacs-lisp
  (defun my-open-current-dir-in-terminal()
    (interactive)
    (let ((dir (expand-file-name default-directory)))
      (start-process "kitty" nil "kitty" dir)
      (message "open %s in terminal" dir)))

  (define-key global-map (kbd "C-c o t") 'my-open-current-dir-in-terminal)
#+end_src
...
#+begin_src elisp
  ...
  (setq org-publish-project-alist
          `(("pages"
             ...
             :base-extension "org"
             :recursive t
             :publishing-directory "~/Developments/blog/public/"
             :auto-sitemap t
