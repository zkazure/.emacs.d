...
#+begin_src elisp
  ...
  (setq ebib-bibtex-dialect 'biblatex
        ebib-preload-bib-files '("~/Documents/zotero/references.bib")
...
#+begin_src elisp
  ...
  ;; basic
  (setq citar-bibliography '("~/Documents/zotero/references.bib"))
  ...
  ;; org-cite
  (setq org-cite-global-bibliography '("~/Documents/zotero/references.bib")
...
#+begin_src elisp
  ...
  (setq citar-org-roam-note-title-template "${author}_${year}_${title}")
