...
#+begin_src emacs-lisp
  ...
  (setq my-org-roam-template-ideas
        (concat "#+TITLE: ${title}\n"
                "#+FILETAGS: :draft:%?:"))
  ...
  (add-to-list 'org-roam-capture-templates
               ...
               `("i" "Ideas" plain
                 ,my-org-roam-template-ideas
                 :target (file "ideas/%<%Y%m%d%H%M%S>-${slug}.org")))


  ;; (add-to-list 'org-roam-capture-templates
  ;;              `("c" "Coding"
  ;;                (("cp" "Python"
  ;;                  (file "coding/${slug}.org")
  ;;                  (concat "#+TITLE: ${title}\n"
  ;;                          "#+FILETAGS: :python:\n\n"
  ;;                          "%?")) ; 光标位置
                  
  ;;                 ("cj" "JavaScript"
  ;;                  (file "coding/javascript/${slug}.org")
  ;;                  ;; 模板内容直接写在这里
  ;;                  (concat "* JavaScript Note: ${title}\n" ; 添加顶级标题
  ;;                          "#+ROAM_TAGS: javascript coding\n\n"
  ;;                          "%?"))
  ;;                 )))
#+end_src
