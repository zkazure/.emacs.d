...
#+begin_src emacs-lisp
  ...
  (defvar my-themes '(modus-operandi-tinted modus-operandi-deuteranopia))
...
#+begin_src emacs-lisp
  ...
  ;; (global-set-key (kbd "M-g e") 'avy-goto-char-2)
  ;; (global-set-key (kbd "M-g n") 'avy-next)
  ;; (global-set-key (kbd "M-g p") 'avy-prev)
...
#+begin_src elisp
  ...
  (define-key global-map (kbd "C-c m l l") 'mc/edit-lines)
  (define-key global-map (kbd "C-c m l e") 'mc/edit-ends-of-lines)
  (define-key global-map (kbd "C-c m l a") 'mc/edit-beginnings-of-lines)
