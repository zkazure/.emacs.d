...
#+begin_src emacs-lisp
  ...
  (add-hook 'css-mode-hook  'emmet-preview-mode) ;; enable Emmet-Preview's css abbreviation.
  (add-hook 'html-mode-hook  'emmet-preview-mode) ;; enable html
  (add-hook 'js-mode-hook 'emmet-preview-mode)
